                        ...
                        <div class="row">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php if ($account->getLogo()): ?>
                                            <div class="container">
                                                ...
                                                <div class="row justify-content-center">
                                                    <div>
                                                    <button id="removelogo" style="margin: 10px" type="button" class="btn btn-primary btn-sm"
                                        ...
                                        <div class="form-group inputDnD">
                                            ...
                                            <input type="file" name="fileToUpload"
                                                   ...
                                                   data-title="Toevoeg logo. Max 10MB">
                                        </div>
                                        <?php if ($_SESSION['msg2']) {
                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <?php if ($status === "checked") { ?>
                                                <div class="form-check">
                                                    <label style="margin-left: 12px"
                                                           id="inputlabelexpertise<?php echo $expertise->getId(); ?>"
                                                    >Meer info: </label>
                                                    <input style="margin-left: 12px; margin-bottom: 12px"
                                                           id="inputexpertise<?php echo $expertise->getId(); ?>"
                                        ...
                                        <div class="form-group"><label id="extra" style="margin-top: 12px">Extra
                                                expertise: </label>
                                            <input id="extraexpertise" class="form-control" name="extraexpertise"
                                                   type="text" class="row"
                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-header"><h4>Waarover wil ik informatie?</h4></div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php foreach ($allExps as $expertise) : ?>
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                ?>
                                                <input type="checkbox"
                                                       class="form-check-input expectedExpertise"
                                            ...
                                            <?php if ($status === "checked") { ?>
                                                <div class="form-check">
                                                    ...
                                                    <label style="margin-left: 12px;"
                                                           id="inputlabelexpected<?php echo $expertise->getId(); ?>"
                                                    >Meer info: </label>
                                                    <input style="margin-left: 12px; margin-bottom: 12px"
                                                           id="inputexpected<?php echo $expertise->getId(); ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="extraexpected" name="extraexpected"
                                                   type="text" class="row"
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header"><h4>Opslaan</h4></div>

...
<html>
    ...
    <body>
        ...
        <div class="container" >
            ...
            <div class="container" >
            <div class="row"><span class="col-4">naam :</span> <input class="col-8" type="text" name="naam" placeholder="" value = "<?php echo $account->getName(); ?>"/></div>

            <div class="row"><span class="col-4">meer informatie :</span> <input class="col-8" type="text" name="Info" placeholder="" value = "<?php echo $account->getInfo(); ?>"></div>

            <div class="row"><span class="col-4">website :</span> <input class="col-8" type="url" name="website" placeholder="" value = "<?php echo $account->getWebsite(); ?>"></div>
            </div>
            ...
            <div class="container">
                <h3>Mijn expertise:</h3>
                    <div class="row">
                        ...
                        foreach ($allExps as $expertise){ ?>
                            <div class="custom-control custom-checkbox container">
                                <input type="checkbox" class="row expertise custom-control-input" id="expertise<?php echo $expertise->getId(); ?>" <?php
                                foreach($exps as $exp){
                                    if($exp===$expertise) echo "checked";
                                };
                                ?>>
                    ...
                    <div class="row">
                        ...
                        foreach ($allExps as $expertise){ ?>
                            <div class="custom-control custom-checkbox container">
                                <input type="checkbox" class="row expectedExpertise custom-control-input" id="expected<?php echo $expertise->getId(); ?>" <?php

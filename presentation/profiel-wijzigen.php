                                ...
                                <div class="card">   
                                    ...
                                    <form action="profiel-wijzigen.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <?php foreach ($allExps as $expertise) : ?>
                                                ...
                                                <div class="custom-control custom-checkbox form-group">
                                                    ...
                                                    <div id="details-expertise<?= $expertise->getId(); ?>">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <?php foreach ($allExps as $expertise) : ?>
                                                <div class="custom-control custom-checkbox form-group">
                                                    <input type="checkbox" class="custom-control-input expectedExpertise" id="expected<?= $expertise->getId(); ?>" name="expected<?= $expertise->getId(); ?>" <?php if (array_key_exists($expertise->getId(), $expectedExpertises)) { echo "checked"; } ?>>
                                                    <label class="custom-control-label" for="expected<?= $expertise->getId(); ?>"><?= $expertise->getExpertise(); ?></label>
                                                    <div id="details-expected<?= $expertise->getId(); ?>">
